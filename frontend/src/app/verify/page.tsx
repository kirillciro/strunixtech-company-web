...
export default function VerifyPage() {
  ...
  useEffect(() => {
    // success=1 means the backend GET /auth/verify already processed the token and redirected here
    ...
    // No redirect params — treat as a direct token link and call the API ourselves
